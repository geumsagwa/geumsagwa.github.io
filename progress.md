...
## 다음에 할 일 (최대 4개)
1. **심리학사 15화(2-1 분트) ✅ 확정·발행(2026-09-01, id=37)** — 전체 재검증 18항 PASS·실사 그림1·문체/맞춤법 정리 완료 · 업로드·목차 반영 완료
2. **심리학사 16화(2-2 구조주의 — 티치너와 내성법) 수정 → 검토 → 확정** — 초고 완성(26,883자·12절·각주 29) · 수정 시작(2026-09-01) → 무진님 검토 → 확정 시 도판 AI 제작 → 홈페이지 업로드
3. **심리학사 17화(2-3 기능주의 — 윌리엄 제임스와 미국 심리학) 초고 완료 → 무진님 검토 → 확정** — 전면 재작성 완료(2026-09-01, 12절·각주16·24,123자·다중 원천) · 검토 → 확정 → 도판 AI 제작 → 업로드
...
- **심리학사 2권:** 15화(2-1 분트) **✅ 확정·발행(2026-09-01, id=37·전 재검증 PASS)** · 16화(2-2 구조주의) 초고 26,883자·**수정 진행(2026-09-01)** · 17화(2-3 기능주의) **전면 재작성 초고 완료(2026-09-01, 12절·각주16·24,123자·다중 원천)** — 16화 수정·무진님 검토 대기
