...
- 시각(ISO): **`2026-09-16T22:58+09:00`** — **llm-wiki 원고 창: 도판 출처 줄(§8.5.8) 게이트 조문 확정 + CC 도판 소급 13화 20점 + 1·2·3권 7화 줄바꿈 정규화 + 물음표 통일분 재발행 9화.**
  ...
  - [CC 도판 소급 — 이월 과제 ②] **미발행 13화 20점에 §8.5.8 출처 줄 소급** — 3권 37~40화 · 4권 42·44·45·46화 · 5권 48·57·58·59·60화. 캡션(`> **그림N.**`) **바로 아래 줄**에 삽입(PD·CC0는 미표기) · 02 검토내용 13파일에 소급 기록 절 추가 · Commons API(`imageinfo/extmetadata`)로 저작자·라이선스 **전건 재확인** · 게이트 신규 FAIL 0 · 커밋 `64775ba6`(26파일 2,039+/35−). 비해당 확정: 1권 2·9·10화 · 2권 25화 · 4권 43·47화 · 5권 49~56화(채택본이 PD·CC0).
