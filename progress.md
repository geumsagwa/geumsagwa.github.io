...
2. (대기) **철학사 5화 검토** (✅ 집필 완료 2026-08-21 — 피타고라스, 본문 24,226자·각주 23·논증박스 2, 검토내용·분량표 반영, llm-wiki `c1455a6a`) → 무진님 검토 후 수정 반영·확정 예정 · **심리학사 5화 검토** (검토 중 수정 3건 반영 — 스피노자·라이프니츠, 본문 16,866자·각주 13) → 확정 예정
3. (진행) **심리학사 1권 4화 홈페이지 업로드** (✅ 확정 완료 2026-08-21 — 본문 26,720자·각주 24개[^42]~[^65]) — 교차 링크 1건 유지(세계사 2권 47화), reader.html target 동작 확인 필요 — 1-3화 ✅ 확정 (2026-08-20, 본문 17,217자·각주 23개)
4. (선택) 철학사 제6화 집필 (예정: **헤라클레이토스** — 5화 말미 예고됨) · 심리학사 6화 집필 (예정: 로크) · (참고) 세계사 통일 집필지침 무진님 검토 대기 · 딥시크 잔액 소진 시 OpenRouter 전환 대기
