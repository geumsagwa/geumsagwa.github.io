...
## 다음에 할 일 (최대 4개)
1. (대기) **철학사 4화 재검토** (sonnet5 자가 수정 후) — ① 각주 출처 전수 대조(헤로도토스·아리스토텔레스·플라톤·포퍼·세이건·DK 단편) ② 각주 정합성·체계 결정(하위 번호 vs 순차) ③ 분량 보강(목표 20p, 현재 60%) 여부 ④ 도판 스펙 작성 ⑤ 검토내용 작성 → 확정 · (참고) 3화 검토내용 '확인/승인 필요 사항' 피드백 대기
