...
- 시각(ISO): **`2026-09-17T21:29+09:00`** — **6권 6-3(제64화 「인지 신경과학 — 기억·감정·결정」·20쪽) 집필 완성 — E-basis 18,440·각주 35·단어코너 4·도판 6자리·게이트 20/20 PASS·DAV ok=35 bad=0.**
  - [자동수집 · Git] 마지막 세션(2026-09-17T16:00+09:00) 이후:
    · homepage master: HEAD d9fe2aa / origin d9fe2aa ·작업트리 변경 2 :: d9fe2aa 진행 기록: 인계 갱신 (update-handover auto) / b890b4b 진행 기록: 인계 갱신 보정 — 63화 도해 2점(그림5·6) 제작본 배치 반영 / 4829a5c 진행 기록: 인계 갱신 (update-handover auto) / 62d6a0f 진행 기록: 인계 갱신 보정 — 자동수집 Git 블록 압축(게이트 FAIL 대응) · 27,985B PASS / 854fa8a 진행 기록: 인계 갱신 (update-handover auto) / b2221d8 자동: 카드뉴스 갱신 (2026-09-17)
    · llm-wiki master: HEAD 2a12150f / origin 2a12150f ·작업트리 변경 125 :: 2a12150f 심리학사 6권 6-3(제64화) 집필 산출물 + 6-1·6-2(제62·63화) 커밋 (volume6 미추적분 정리) / 0932ba7f HANDOVER: 9차 갱신 — 63화 도판 7자리 무진님 확정(실사 5 승인·도해 2 확정, 도해 손질·규격 정렬 반영) / 204032f6 HANDOVER: 8차 보정 — 63화 도해 2점(그림5·6) 제작본 배치 반영 / 9440b854 HANDOVER: 8차 갱신 — 6권 6-1·6-2(제62·63화) 집필 완성·검증 파이프라인 통과 반영 / 503e4061 HANDOVER: 7차 갱신 — 미커밋분 8커밋 커밋·푸시(109파일) · "4·5권 미커밋 유지" 관행 폐지(6차 ⑥ⓐ 해소) / 7b74b8d1 작업 노트·작성지침 체크포인트 추가 / 800f
    · harness  main: HEAD 6551f15 / origin 6551f15 ·작업트리 변경 3 :: 6551f15 docs(desktop-handoff): 인계 갱신 동기 (update-handover auto) / 42d58af docs(desktop-handoff): 인계 갱신 보정 — 63화 도해 제작본 배치 반영 / ffbaaa1 docs(desktop-handoff): 인계 갱신 동기 (update-handover auto) / ed0c498 docs(desktop-handoff): 인계 갱신 보정 — 자동수집 Git 블록 압축(게이트 FAIL 대응) · 27,985B PASS / 2f3f50b docs(desktop-handoff): 인계 갱신 동기 (update-handover auto)
    · openclaw main: HEAD 11a8f0a / origin 11a8f0a ·작업트리 변경 5 :: (커밋 없음)
  - [제64화(6-3 · 20쪽)] 본문 `6권_64화_01_인지-신경과학-기억-감정-결정.md`(62,634 B · sha256 앞16 `b6785f8164666091…`)·검토내용 ②·도판의뢰서 ③ 완비. 12절·112문단. E-basis 18,440(목표 18,000~18,900)·각주 35·단어코너 4(인지·공고화·편도체·도파민)·도판 6/캡션 6/출처 줄 4.
  - [조사·검증 — `ws_tmp/ep64-research/`] 조사 캐시 `pages/` 77문서·`queries64.tsv` 80건(각주 근거 = 영어 위키백과 23종). 게이트 `gate_common.py` **PASS(20/20)** · DAV `_dav64.py` **ok=35 bad=0** · 후보 매핑 `_cand64.py` **73행(수치 28 + 인용 44) 불일치 0 · NOPAGE 0** · `_seclen64.py` 18,440.
  - [도판 6자리] 여섯 자리 모두 위키미디어 공용 기존 파일로 충당(자작 도해 0) — 그림1 해마 위치(CC0·출처 줄 없음)·그림2 존 오키프(CC BY 2.0)·그림3 브렌다 밀너(CC BY 2.0)·그림4 다마지오(CC BY-SA 4.0)·그림5 아이오와 도박 과제(PD)·그림6 보상 예측 오차(CC BY-SA 4.0). 800px 미만 2자리(그림1 667×649·그림5 642×478)는 확대하지 않고 사용. 가자니가 후보(223×251·GFDL) 탈락 → 1절 초상 자리를 §3 오키프로 이동.
  ...
  - [상태·미발행] 심리학사 발행분은 여전히 **제1~36화(ids 12~58)**. 64화 산출물 3종은 **미발행** — 검토·확정·발행은 무진님 직접.
  - [다음 작업] **6권 6-4(제65화) 집필** → 6-14(제75화)까지. 인프라·검증 파이프라인은 62~64화와 동일하게.
  - 상세(자동): 콘텐츠 커밋 llm-wiki@2a12150f (심리학사 6권 6-3(제64화) 집필 산출물 + 6-1·6-2(제62·63화) 커밋) — 푸시 완료.
...
- 시각(ISO): **`2026-09-17T08:18+09:00`** — **6권 6-1·6-2(제62화 「신경과학의 도약 — 마음의 지도」·제63화 「진화 심리학 — 마음은 설계되었다」) 집필 완성** — 산출물 3종(01 본문·02 검토내용·도판의뢰서)과 도판 7자리씩 배치까지 마쳤고, 검증 파이프라인을 모두 통과했다. **미커밋·미발행**(무진님 검토·확정 몫).
  - [자동수집 · Git] 마지막 세션(2026-09-17T06:09+09:00) 이후:
    · homepage master: HEAD 62d6a0f / origin 62d6a0f ·작업트리 변경 2 :: 7차 인계 갱신(보정 `62d6a0f`·`854fa8a`) · `b2221d8` 카드뉴스 자동 갱신(2026-09-17)
    · llm-wiki master: HEAD 503e4061 / origin 503e4061 ·작업트리 변경 106(volume6 62·63화 신규 포함) :: `503e4061` HANDOVER 7차 갱신·미커밋분 8커밋(109파일) · 이전 `7b74b8d1`…`800f4fd7`(5권 61화 원고 마감)
    · harness  main: HEAD ed0c498 / origin ed0c498 ·작업트리 변경 3 :: `ed0c498` 인계 갱신 보정(27,985B PASS) · `2f3f50b` 인계 갱신 동기
    · openclaw main: HEAD 11a8f0a / origin 11a8f0a ·작업트리 변경 5 :: (커밋 없음)
