...
## 다음에 할 일 (최대 4개)
1. (진행) **철학사 교차 링크 자동 삽입** — 6화 검토내용 교차 링크 계획 기준: ①5화 12절→6화 ②1화 §3(로고스 예고)·§6(DK22)→6화 ③3화 §2(에페소스 헤라클레이토스)→6화 ④심리학사 1화 L47(영혼=불·로고스)→철학사 6화 · ⑤6화 본문(5화 막간 예고·제1화 로고스·심리학사 1화) 역방향 — **철학사 1~5화에도 아직 교차 링크 미삽입** (6화 확정·업로드 후 일괄 적용)
2. (대기) **철학사 7화(파르메니데스) 집필** (6화 12절 말미 예고 연결)
3. (대기) 세계사 통일 집필지침 무진님 검토 대기 · 딥시크 잔액 소진 시 OpenRouter 전환 대기
4. ✅ (2026-08-26 해소) **철학사 6화 확정·업로드 완료** — id=27(제6화 헤라클레이토스 — 흐름과 로고스) · 각주 내용 대응 오류([^33]~[^41] 정렬) 수정 반영 · 최종 분량 24,629자 · 홈페이지 등록: 1(id=8)·2(id=15)·3(id=16)·4(id=17)·5(id=18)·6(id=27)
...
- **철학사 1권:** 1~6화 홈페이지 업로드 완료(id 8·15·16·17·18·27) — **1화(id=8)** · **2화(id=15)** · **3화(id=16)** · **4화(밀레토스 학파 — 제4화 탈레스, id=17) 확정(2026-08-22)·업로드 ✅** · **5화(피타고라스 — 수의 신비, id=18) 확정(2026-08-22 무진님 승인)·업로드 ✅** · **6화(헤라클레이토스 — 흐름과 로고스) 확정(2026-08-26)·업로드 ✅(id=27)** — 08-23 그림1(30만 년 시계) 완성·홈페이지 반영 ✅ · 08-20 무진님 수정 원고로 2화 교체·SVG base64 인라인 반영 ✅ · 6화는 전체 재검증에서 각주 [^33]~[^41] 내용 정렬 오류 수정 반영 · 최종 분량 24,629자 · **교차 링크 자동 삽입 대기**(철학사 1~5화에도 미삽입)
