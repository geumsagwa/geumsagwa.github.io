...
- 시각(ISO): **`2026-09-16T20:05+09:00`** — **llm-wiki 원고 창: 인계 3차 ⚠️(4화 재발행) 이행 + 1권 도해 안 캡션 폐지 소급(무진 승인) + 2권 27화 그림4 크롭 + 소제목 물음표 통일(무진 지시).** `publish-series-episodes.mjs --update`로 **심리학사 1~10화 · 19·22·27·34·35화 재발행**(도판 출처 줄·본문 캡션·물음표 반영). 지침 §1에 물음표 규칙 신설. 커밋 `c9d2cc58`·`35bec95e`. 미커밋 잔여는 무진님 판단 대기(요약 하단 참조).
  - [자동수집 · Git] 마지막 세션(2026-09-16T09:51+09:00) 이후:
    · homepage master: HEAD 5a11afd / origin 5a11afd ·작업트리 변경 3 :: 5a11afd 진행 기록: 인계 갱신 (update-handover auto) / 0fec457 자동: 카드뉴스 갱신 (2026-09-16)
    · llm-wiki master: HEAD 35bec95e / origin 583f5317 ·작업트리 변경 222 :: 35bec95e 소제목 물음표 통일(무진 지시) — 지침 §1에 규칙 기록 + 발행분 반영 / c9d2cc58 1권 도해 캡션 본문화 + 도해 안 캡션 폐지 소급 반영 (심리학사 1~10·27화 재발행) / 583f5317 HANDOVER: 제59화·제60화 집필 완성 + 도해 팔레트 일괄 정정 반영
    · harness  main: HEAD 60a7e25 / origin 60a7e25 ·작업트리 변경 3 :: 60a7e25 docs(desktop-handoff): 인계 갱신 동기 (update-handover auto)
    · openclaw main: HEAD 11a8f0a / origin 11a8f0a ·작업트리 변경 5 :: (커밋 없음)

  - [확정·상태] **① 4화 재발행 완료**(2권 19·22 · 3권 34·35 — §8.5.8 출처 줄 `fig-credit` DB 반영 확인: 19화 2·22화 1·34화 2·35화 2건) · **② 1권 1~10화 도해 안 캡션 크롭 제거 → 본문 `> **그림N.**` 캡션 이관**(원본 `…_복원포인트_20260916.png` 보관) 후 재발행 · **③ 2권 27화 그림4 크롭** 후 재발행 · **④ 소제목 물음표 통일**(지침 §1 규칙 신설 — 의문문 소제목엔 `?`, 부제 앞 주절 끝 / 서술문·명사절 `…는지`엔 미부착) 적용 = 심리학사 1권 1·13 · 2권 17·18·19·22·25·26 · 3권 34·35 · 5권 54·58화, 철학사 1·4·8·10화 + 02 미러 정정, 부수 구두점 정정 3건(2권 27·18화).
  - [사고·복구(공개)] `manuscripts/psychology/volume1/1권_10화_02_검토내용.md`가 정규화 스크립트 인코딩 버그(`open(p,'wb')` 후 `TypeError`)로 0바이트 소실 → git HEAD 판본에서 재구성(캡션라벨 3·노트 3, 꼬리 바이트 HEAD 동일). 다른 피해 0(0바이트 파일 전수 확인) · 스크립트 `bytes.decode()`+`str.join`으로 수정.
  - [다음 작업] llm-wiki는 **HANDOVER.md 4차 노트 반영**(이 파이프라인과 별개로 wiki repo에 커밋). 남은 승인 대기: 물음표 통일분 재발행(심리학사 1권 13·2권 17·18·25·26화 · 철학사 1·4·8·10화) · 3차 ⚠️ CC 도판 소급 적용. 잔여 미커밋(문체 다듬기·캡션라벨 sweep·5권 57~60화·세계사 파일군)은 무진님 판단 대기.
