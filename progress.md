...
## 다음에 할 일 (최대 4개)
1. (진행) **심리학사 1권 4화 홈페이지 업로드** (✅ 확정 완료 2026-08-21 — 본문 26,720자·각주 24개[^42]~[^65], 검토내용·분량표 반영됨, llm-wiki `ad55db4d`) — 교차 링크 1건 유지(세계사 2권 47화), reader.html target 동작 확인 필요 — 1-3화 ✅ 확정 (2026-08-20, 본문 17,217자·각주 23개)
2. (선택) LLM Wiki §5 cmd ETIMEDOUT 근본 원인 조사 — `publish-briefing.ps1`의 wiki stats 호출부 검토 (08-20 정상 동작 확인, 방지 목적 — 무진님 판단)
...
- **철학사 1권:** 제1화(id=8)·제2화(id=15) 연재 중 — 08-20 무진님 수정 원고로 2화 교체·SVG base64 인라인 반영 ✅ (레코드 중복 없음) — 제6화 집필 대기
...
- **homepage:** `d9c1da8` — progress.md 08-21 본문 문장 수정 세션 갱신 (이전 `a3fdf64`: 에세이 이미지 반응형 · `e848cbe`: .serena memories 제외 · `7556ab0`: 08-20 브리핑 카드뉴스 · `cf40fe0`: 틸드 취소선 보강 · `2bcf0d5`: 연재 발행 파이프라인 통합 · `2b95b62`: 심리학사 연재 등록) — progress.md 4화 확정 세션 갱신 후 재커밋 예정
