...
## 마지막 갱신
- 시각(ISO): `2026-05-11T21:45:00+09:00` — **이야기 세계사 Ⅲ** 지도 12장 등 **`47123bc`** (`master`) **커밋·푸시 완료**.
...
- **tip:** **`47123bc`** (`origin/master`, 2026-05-11) — **`git fetch` 후 `git rev-parse origin/master`** 로 재확인.
