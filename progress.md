...
2. **심리학사 17화(2-3 기능주의 — 윌리엄 제임스와 미국 심리학) 무진님 검토 → 확정 → 도판 → 발행** — 전면 재작성 초고 완료(2026-09-01, 12절·각주16·24,123자·다중 원천) · 16화 발행 완료로 다음 검토 대상
...
- **심리학사 2권:** 15화(2-1 분트) **✅ 확정·발행(2026-09-01, id=37)** · 16화(2-2 구조주의) **✅ 확정·발행(2026-09-02, ep16·id=38, 26,614자·초상 실사 도입)** · 17화(2-3 기능주의) **전면 재작성 초고 완료(2026-09-01, 12절·각주16·24,123자·다중 원천)** — 17화 무진님 검토 대기
