...
## 다음에 할 일 (최대 4개)
1. (진행) **철학사 6화(헤라클레이토스) 검토·확정·업로드** (✅ 초고+검토내용 완료 2026-08-25 — 본문 25,057자·각주 53·도판 4종 §8.5 완성) → 무진님 검토 → 확정 시 ① SERIES_MAP philosophy 6화 등록 ② 도판 4종 base64 인라인 업로드 ③ 교차 링크 자동 삽입 워크플로우 적용(철학사 6화 관련 세계사·심리학사 연결 탐색 — '흐름·로고스·파르메니데스' 등)
2. (대기) **철학사 5화(피타고라스) 확정 상태 재확인** (✅ 집필 완료 2026-08-21 — 본문 24,226자·각주 23·논증박스 2) — 6화 집필이 5화 확정을 전제로 진행되었으나 progress 기록상 확정 소식 미기재 → 무진님께 확인 후 progress 반영
...
4. (대기) **다음 교차 대상 — 철학사 7화 집필** (심리학 10화까지 완료 · 철학사 6화 확정·업로드 후) · 세계사 통일 집필지침 무진님 검토 대기 · 딥시크 잔액 소진 시 OpenRouter 전환 대기
