...
## 다음에 할 일 (최대 4개)
1. (대기) **철학사 4화 재검토** (sonnet5 자가 수정 후) — **제출 게이트(집필지침 §4.6: 분량 실측·각주 정합성·출처 대조표 3종 보고) 먼저 적용** → ① 각주 출처 전수 대조(헤로도토스·아리스토텔레스·플라톤·포퍼·세이건·DK 단편) ② 각주 정합성·체계 결정(하위 번호 vs 순차) ③ 분량 보강(목표 20p, 현재 60%) 여부 ④ 도판 스펙 작성 ⑤ 검토내용 작성 → 확정 · (참고) 3화 검토내용 '확인/승인 필요 사항' 피드백 대기
2. (진행) **심리학사 1권 4화 홈페이지 업로드** (✅ 확정 완료 2026-08-21 — 본문 26,720자·각주 24개[^42]~[^65], 검토내용·분량표 반영됨, llm-wiki `ad55db4d`) — 교차 링크 1건 유지(세계사 2권 47화), reader.html target 동작 확인 필요 — 1-3화 ✅ 확정 (2026-08-20, 본문 17,217자·각주 23개)
3. (진행) 심리학사 1권 5화 집필 예정 (스피노자·라이프니츠 — 각주 [^66]부터)
4. (선택) 철학사 제6화 집필 (예정: 아낙시메네스 또는 엘레아 학파) · (참고) 세계사 통일 집필지침 무진님 검토 대기 · 딥시크 잔액 소진 시 OpenRouter 전환 대기
...
- **철학사 1권:** 제1화(id=8)·제2화(id=15) 연재 중 — 08-20 무진님 수정 원고로 2화 교체·SVG base64 인라인 반영 ✅ (레코드 중복 없음) — **제4화(밀레토스 학파) sonnet5 초고 각주·분량 문제 발견(08-21) → sonnet5 거짓말 실토 → 자가 수정 후 재검토 대기** · 제6화 집필 대기
...
- **LLM Wiki:** `ad55db4d` — 심리학사 1-4화 확정 (검토내용 작성 + 나이·연도 수정 3건 + 분량표 26,720자) ✅ push 완료 (커밋된 범위 clean · **철학사 폴더 개편 등 타 변경은 워킹트리에 잔존**) (이전 `cd99e8b0`: 4화 본문 문장 수정 · `82e8ec3d`: 4화 각주 [^47] 보강 · `59c892ce`: 1-3화 확정+검토내용+분량표 · `d31789cb`: 1-3화 초고 · `47af67fb`: 1-2화 확정 · `bb8079ed`: 1-1화 확정+검토내용)
- **homepage:** `b62f4ed` — progress.md 08-21 심리학사 4화 확정 세션 갱신 (이전 `d9c1da8`: 08-21 본문 문장 수정 · `2ceb169`: 08-21 각주 [^47] 보강 · `33e897d`: 세계사 집필지침+교차 링크 화 확정 후 · `b7c4430`: 프로젝트 지침 구조 이해 · `a3fdf64`: 에세이 이미지 반응형 · `e848cbe`: .serena memories 제외 · `cf40fe0`: 틸드 취소선 보강) — progress.md 후속 세션(철학사 4화 검토) 갱신 후 재커밋 예정
