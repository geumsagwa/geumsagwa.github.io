  ...
  psychology: {
    ...
    episodes: {
      ...
      15: {
        ...
        file: "2권_15화_01_분트-라이프치히-심리학의-실험실.md",
      ...
      16: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_16화_01_구조주의-티치너와-내성법.md",
      ...
      17: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_17화_01_기능주의-윌리엄-제임스와-미국-심리학.md",
      ...
      18: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_18화_01_의식의-흐름-심리학원리.md",
      ...
      19: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_19화_01_게슈탈트-심리학-베르트하이머와-쾰러.md",
      ...
      20: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_20화_01_지능의-측정-비네와-IQ의-탄생.md",
      ...
      21: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_21화_01_발달-심리학의-탄생-홀과-볼드윈.md",
      ...
      22: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_22화_01_동물-심리학-비교와-실험의-시작.md",
      ...
      23: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_23화_01_임상-심리학의-시작-위트머와-심리-클리닉.md",
      ...
      24: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_24화_01_응용-심리학-산업-교육-군대.md",
      ...
      25: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_25화_01_여성-심리학자들-칼킨스와-워시번.md",
        title: "제25화 여성 심리학자들 — 칼킨스와 워시번",
        excerpt: "남학생들 틈에 앉은 한 여자 '손님'. 이름도 성적도 졸업장도 없이 수업을 들을 수만 있던 시대, 메리 휘턴 칼킨스는 마음의 '안'(자아)을, 마거릿 플로이 워시번은 마음의 '밖'(동물의 행동)을 향했다. 여자가 세운 첫 심리학 실험실, 하버드가 끝내 거부한 박사 학위, 그리고 두 여성의 이름이 학회의 문을 열어 가는 과정을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=400&h=530&fit=crop",
      },
      26: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_26화_01_심리학의-확산-유럽에서-미국으로.md",
        title: "제26화 심리학의 확산 — 유럽에서 미국으로",
        excerpt: "1879년, 라이프치히의 작은 방 하나에서 태어난 실험 심리학은 스무 해 만에 대서양을 건너 미국에서 가장 크게 자랐다. 홀의 존스홉킨스 첫 실험실(1883)을 시작으로 1887~89년 실험실이 줄지어 문을 열고, 학회(APA)·학술지·교과서가 '나라 없던 학문'에 하나의 공동체를 만들어 주었다. 학문은 다시 프랑스·영국·러시아로 퍼져 나가고, 나치 시대에는 유럽의 학자들이 미국으로, 그리고 모토라와 마쓰모토를 태워 태평양 건너 일본까지 — '한 방'의 학문이 사람과 배를 타고 바다를 건너 세계로 퍼져 나간 여정을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1533460004989-cef01064af7e?w=400&h=530&fit=crop",
      },
      27: {
        dir: "F:/wiki/manuscripts/psychology/volume2",
        file: "2권_27화_01_학파들의-대립-20세기-초-심리학의-지형.md",
        title: "제27화 학파들의 대립 — 20세기 초 심리학의 지형",
        excerpt: "20세기 초, 마음의 과학은 서로 다른 진영으로 갈라섰다. 무엇을 보는가(대상)와 어떻게 보는가(방법)를 둘러싸고 구조주의·기능주의·행동주의·게슈탈트가 저마다의 이름을 내걸었고, 정신분석은 그 지형 바깥에서 무의식을 좇았다. 학파들의 싸움이 한창일 무렵, 몇몇 학자는 그 학파들을 한 권의 책으로 묶어 '지도'를 그리기 시작했다 — 학파의 시대가 저물어 가는 20세기 초 심리학의 지형을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=400&h=530&fit=crop",
      },
      28: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_28화_01_프로이트-무의식의-발견.md",
        title: "제28화 프로이트 — 무의식의 발견",
        excerpt: "1885년 가을, 파리 살페트리에르의 강당. 말 한마디로 생겼다가 말 한마디로 사라지는 마비 앞에서, 빈의 젊은 의사 프로이트는 몸이 아니라 마음이 병을 만든다는 낯선 세계를 처음 보았다. 브로이어의 환자 안나 O.는 지난 일을 말로 풀어내는 '말하는 치료'로 나았고, 프로이트는 대화 속에서 자신조차 모르던 마음, 무의식을 만난다. 유혹 이론의 붕괴와 아버지의 죽음, 자기 분석을 거쳐 『꿈의 해석』까지 — '내가 모르는 나'라는 새로운 마음의 영역이 열리던 순간을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1521587760476-6c12a4b040da?w=400&h=530&fit=crop",
      },
      29: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_29화_01_프로이트-꿈의-해석.md",
        title: "제29화 프로이트 — 꿈의 해석",
        excerpt: "밤마다 찾아오는 이상한 영상들 — 꿈. 19세기 과학이 '꿈은 뜻없는 소음'이라며 등을 돌린 그곳에서, 프로이트는 무의식이 밤마다 우리에게 말을 거는 길을 보았다. 1895년 벨뷰에서 꾼 '이르마의 주사' 꿈을 스스로 해부하는 데서 출발해, 꿈이 검열을 피해 숨은 소원을 위장해 이루는 장면임을 밝히고, 현상 내용과 잠재 내용·꿈-작업이라는 해석의 도구를 세운다. 1900년 《꿈의 해석》은 훗날 정신분석 운동의 창립 문서가 되고, 초현실주의자들의 꿈 기록으로까지 이어진다 — 한 편의 꿈을 해부하며 프로이트의 꿈 이론이 가지를 뻗어 가는 이야기를 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=400&h=530&fit=crop",
      },
      30: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_30화_01_프로이트-성격-구조와-방어기제.md",
        title: "제30화 프로이트 — 성격 구조와 방어기제",
        excerpt: "나는 왜 이렇게 행동할까. 참을성 있는 사람과 급한 사람, 잘 웃는 사람과 잘 화내는 사람 — 저마다의 성격은 어디서 오는가. 1909년, 말이 무서워 길에 나서지 못하는 다섯 살 소년 '작은 한스'의 공포증에서 출발한 프로이트의 관찰은, 한 사람의 마음을 '원초아·자아·초자아'라는 세 힘이 어우러져 움직이는 그림으로 자라난다. 마음의 평화를 지키려 스스로를 속이는 방어기제(억압·투사·승화…)를 밝혀 내고 — 한 아이의 공포증이 하나의 성격 이론이 되어 가는 과정을 따라간다.",
        card_image_url: "https://images.unsplash.com/photo-1554188248-986adbb73be4?w=400&h=530&fit=crop",
      },
      31: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_31화_01_프로이트-정신분석-운동의-분열.md",
        title: "제31화 프로이트 — 정신분석 운동의 분열",
        excerpt: "한 지붕 아래 모였던 학문은 어떻게 여럿으로 갈라지는가. 1909년 클라크 대학에서 아버지와 왕세자처럼 나란히 앉았던 프로이트와 융. 그 후 운동은 가장 가까운 사람들과의 이별을 겪는다 — 다른 그림을 그린 아들러의 출가, 리비도를 넓힌 융의 반란. 이별을 겪으며 프로이트는 죽음 본능이라는 어두운 생각을 마음에 끌어안고, 개인의 마음에서 인류의 문명으로 눈을 넓힌다. 병과 망명, 마지막 순간까지 — '아버지와 아들'의 이별이 후기 사상으로 자라나는 이야기를 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=400&h=530&fit=crop",
      },
      32: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_32화_01_융-집단무의식과-원형.md",
        title: "제32화 융 — 집단무의식과 원형",
        excerpt: "벽장 속에 조그만 인간을 숨겨 두고 자기만의 의식을 올리던 소년이 있었다. 몇십 년 뒤 그 소년은, 한 번도 만난 적 없는 먼 땅의 의식과 자기 의식이 놀랍도록 닮았다는 것을 알게 된다. 프로이트의 제자였던 융은 환자들의 꿈과 환각에서 겪어 본 적 없는 오래된 이야기들이 저절로 떠오르는 것을 보고, 잊힌 개인의 경험을 넘어 인류가 함께 물려받은 '집단 무의식'과 그 안에 새겨진 '원형'이라는 틀을 세운다. 결별의 어둠 속에서 검은 공책에 환영을 받아 적고 붉은 책을 그려 낸 한 사람이 마음의 가장 깊은 층에 다다른 이야기 — '내 것'이 아닌 마음의 발견을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1518241353330-0f7941c2d9b5?w=400&h=530&fit=crop",
      },
      33: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_33화_01_융-분석-심리학의-실천.md",
        title: "제33화 융 — 분석 심리학의 실천",
        excerpt: "나는 '나' 하나일까, 아니면 마음속에 여럿이 살고 있을까. 1909년 융은 취리히의 병원을 떠나 쿠스나흐트의 자기 집에 진료실을 열고, 죽는 해인 1961년까지 반백 년 가까이 그 방을 지켰다. 가면(페르소나) 뒤의 그림자, 꿈에 자꾸 찾아오는 아니마와 아니무스, 그리고 그 모두를 품는 마음의 중심 '자기' — 낯선 손님들과 한집에서 살아가는 법, 그리고 '나다워진다'는 것의 의미를 한 사람의 진료실에서 풀어낸다.",
        card_image_url: "https://images.unsplash.com/photo-1493246507139-91e8fad9978e?w=400&h=530&fit=crop",
      },
      34: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_34화_01_아들러-열등감과-우월-추구.md",
        title: "제34화 아들러 — 열등감과 우월 추구",
        excerpt: "남보다 못하다는 느낌은 사람을 주저앉히는 병일까, 앞으로 밀어 주는 힘일까. 어릴 적 구루병으로 네 살까지 걷지 못하고 폐렴으로 죽을 고비를 넘긴 빈의 소년 알프레트 아들러는, 병약한 몸과 늘 견주어지는 형이라는 '남보다 못하다는 느낌'을 안고 자라 의사가 되었다. 그 느낌을 '열등감'이라 부른 그는 그것이 병이 아니라 사람을 앞으로 움직이는 힘이며, 그 힘이 남을 이기려는 우월 콤플렉스로 흐르느냐 함께 자라는 공동체 감각으로 흐르느냐가 한 사람의 삶을 가른다고 보았다. 세계 최초의 아동 상담소를 세우고 소파 대신 두 의자를 놓은 한 사람의 걸음을 따라간다.",
        card_image_url: "https://images.unsplash.com/photo-1544027993-37dbfe43562a?w=400&h=530&fit=crop",
      },
      35: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_35화_01_신프로이트파-호나이-설리번-프롬.md",
        title: "제35화 신프로이트파 — 호나이·설리번·프롬",
        excerpt: "한 사람의 마음은 어디서 자라는가. 독일에서 '여자라는 이유'의 벽과 맞서 여성 심리학을 연 카렌 호나이, 미쳤다는 말을 듣던 조현병 환자들과 오래 말을 나눈 해리 스택 설리번, 사회학 책상에서 정신분석으로 건너간 에리히 프롬. 1930~40년대 뉴욕에 모인 세 사람은 프로이트의 무의식을 버리지 않으면서, 마음이 사람과 사람 사이, 그리고 시대와 문화 속에서 자란다는 다른 그림을 그렸다. '중요한 타인'과 기본 불안, 자유로부터의 도피와 사랑의 기술 — 스승의 곁을 떠나 마음의 바깥을 그린 사람들의 이야기를 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=400&h=530&fit=crop",
      },
      36: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_36화_01_정신분석의-확산-미국과-세계.md",
        title: "제36화 정신분석의 확산 — 미국과 세계",
        excerpt: "빈의 작은 진료실에서 태어난 '무의식'이라는 낱말은 어떻게 세계의 말이 되었을까. 갈리치아 출신 이민자 브릴이 프로이트의 글을 처음 영어로 옮기고, 존경받던 원로 의사 퍼트남이 새 말에 문을 열고, 1909년 클라크 대학 강연을 계기로 낱말은 대서양을 건넌다. 나치의 박해가 분석가들을 미국으로 밀어낸 두 번째 물결, 전쟁이 키운 군의 정신의학, 그리고 미국에서 자란 학문이 다시 런던·파리·도쿄로 되돌아가는 세 번째 물결까지 — '낱말의 여행'을 따라 정신분석이 세계의 언어가 되어 가는 과정을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?w=400&h=530&fit=crop",
      },
      37: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_37화_01_정신분석의-비판-증거와-윤리.md",
        title: "제37화 정신분석의 비판 — 증거와 윤리",
        excerpt: "정신분석은 과학인가. 포퍼는 반증 가능성이라는 기준을 세워 정신분석을 의사과학으로 보았고, 아이젱크는 1952년 문헌에 실린 19 건의 치료 결과 연구를 다시 세어 그 효과에 의문을 던졌다. 그륀바움의 중간 입장과 2020년 메타분석까지 — 효과를 어떻게 재는가라는 물음은 아직 진행형이다. 그리고 1980년대 '회복 기억 치료'가 남긴 상처는, 치료자가 휘두르는 힘을 지키는 일이 왜 윤리의 문제인지 보여 준다. 증거와 윤리가 만나는 자리를 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=400&h=530&fit=crop",
      },
      38: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_38화_01_무의식의-과학적-탐구.md",
        title: "제38화 무의식의 과학적 탐구",
        excerpt: "내 마음은 내가 다 아나요? 시끄러운 모임에서도 내 이름만은 쏙 들어오고, 좋아하는 까닭은 말로 설명되지 않는다 — 의식 너머에서 마음이 하는 일을 실험으로 파고든다. 두 귀에 다른 말을 들려주는 칵테일 파티 효과, 색과 글자가 부딪히는 스트룹, 보지 못하는데 보는 맹시, 잊어도 남는 암묵 기억, 이유보다 먼저 오는 좋아함, 그리고 1957년 극장의 '숨은 광고'까지. 진료실을 떠나 실험실에서 다시 태어난 무의식을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&h=530&fit=crop",
      },
      39: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_39화_01_코헛-자기-심리학.md",
        title: "제39화 코헛 — 자기 심리학",
        excerpt: "칭찬받고 싶다, 우러르고 싶다, 나와 같은 친구가 필요하다 — 어른이 되면 없어야 할 어린애 버릇일까. 정신분석 전통의 심장부에 있던 하인츠 코헛은 자기애를 미성숙이 아니라 평생 이어지는 필요로 다시 읽었다. 공감을 관찰의 도구로 세우고, 자기대상과 거울·이상화 전이, 자기애적 분노, 그리고 견딜 만한 실망이 자기를 키운다는 '적절한 좌절'까지 — 자기 심리학을 세운 그의 이야기를 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1508193638397-1c4234db14d8?w=400&h=530&fit=crop",
      },
      40: {
        dir: "F:/wiki/manuscripts/psychology/volume3",
        file: "3권_40화_01_심층-심리학의-유산.md",
        title: "제40화 심층 심리학의 유산 — 무의식은 오늘 어디에 있을까?",
        excerpt: "그 큰 낱말은 지금 우리에게 무슨 일을 하고 있을까. 검사실의 잉크 반점, 박물관이 된 옛 진료실의 소파, 달리와 프로이트가 만난 날, 이상의 《오감도》, 골목까지 내려온 '무의식'이라는 우리말, 실험실에서 다시 태어난 무의식까지 — 백 년 동안 낱말 하나가 남긴 자리를 두루 돌아본다. 무의식의 시대를 닫는 3권의 마지막 화.",
        card_image_url: "https://images.unsplash.com/photo-1589998059171-988d887df646?w=400&h=530&fit=crop",
      },
      41: {
        dir: "F:/wiki/manuscripts/psychology/volume4",
        file: "4권_41화_01_왓슨-행동주의-선언.md",
        title: "제41화 왓슨 — 행동주의 선언",
        excerpt: "마음의 안쪽을 살피던 심리학이 문을 닫고, 몸이 드러내는 움직임을 다루는 심리학이 문을 열던 때. 그 문 앞에 처음 선 사람은 눈에 보이는 행동만을 심리학의 재료로 삼자고 선언한 존 왓슨이었다. 남부 시골의 엄격한 신앙 집안에서 자라 쥐의 미로로 실험을 배우고, 1913년 〈심리학을 행동주의자가 본다면〉으로 의식이라는 낱말을 지우고, 1920년 레이너 스캔들로 학계를 떠나 광고 회사의 심리학자가 되기까지 — 행동의 시대를 연 사람의 삶과 그가 남긴 빛과 그늘을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1518152006812-edab29b069ac?w=400&h=530&fit=crop",
      },
      42: {
        dir: "F:/wiki/manuscripts/psychology/volume4",
        file: "4권_42화_01_파블로프-고전적-조건화.md",
        title: "제42화 파블로프 — 고전적 조건화",
        excerpt: "개가 종소리만 들어도 침을 흘리게 만들 수 있다. 먹이가 나오기도 전에 종소리만 듣고 몸이 먼저 준비를 갖추는 이 장면 안에, '몸이 저절로 무언가를 미리 배운다'는 이야기가 숨어 있다. 개의 침을 재던 생리학자 파블로프는 우연히 만난 이 반사를 몇 해씩 파고들어 배움의 법칙으로 세웠고, 그 발견은 왓슨과 스키너의 행동주의를 떠받치는 실험의 발판이 되었다 — 무엇을, 어떻게, 어디까지 배우는가라는 물음을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=400&h=530&fit=crop",
      },
      43: {
        dir: "F:/wiki/manuscripts/psychology/volume4",
        file: "4권_43화_01_작은-앨버트-공포의-학습.md",
        title: "제43화 작은 앨버트 — 공포의 학습",
        excerpt: "한 번도 무서워한 적 없던 흰 쥐가, 어느 날 갑자기 무서운 것이 된다. 1920년 볼티모어 존스 홉킨스의 한 방에서 왓슨과 로잘리 레이너는 아기 하나에게 흰 쥐를 보여 주고 등 뒤에서 쇠막대를 울렸다 — 배움으로 공포를 심는 실험이었다. 교과서에 실린 그 장면은 한 세기 동안 '공포는 조건화된다'는 명제의 얼굴이 되었지만, 원래 기록이 보여 주는 것은 그보다 훨씬 흐릿하고 불규칙하다 — 이름조차 확실해지지 않은 아기, 실패로 끝난 제거 계획, 그리고 공포를 지우는 데 성공한 다음 아이 피터까지, '작은 앨버트' 실험의 빛과 그늘을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1522771930-78848d9293e8?w=400&h=530&fit=crop",
      },
      44: {
        dir: "F:/wiki/manuscripts/psychology/volume4",
        file: "4권_44화_01_스키너-조작적-조건화와-강화.md",
        title: "제44화 스키너 — 조작적 조건화와 강화",
        excerpt: "상자 안의 비둘기는 몹시 배가 고팠지만, 먹이는 제가 무엇을 하든 일정한 간격으로 나왔다. 그런데 얼마 지나자 새들은 저마다 다른 동작을 되풀이하기 시작했다 — 자기 동작이 먹이를 부른다고 굳게 믿는 듯이. 이 미신 비둘기 실험에서 스키너는 왜 어떤 행동은 자꾸 하고 어떤 행동은 하지 않게 되는지를 물었다. 답은 마음속이 아니라 행동 뒤에 있었다. 손다이크의 고양이 상자에서 물려받은 법칙을 자기 실험실의 언어로 다시 세우고, 강화와 처벌이라는 두 열쇠로 행동이 늘고 줄어드는 방식을 밝힌 사람 — 발명품을 좋아한 소년이 20세기 심리학의 얼굴이 되기까지를 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1549216580-cdaa97339899?w=400&h=530&fit=crop",
      },
      45: {
        dir: "F:/wiki/manuscripts/psychology/volume4",
        file: "4권_45화_01_스키너-행동설계.md",
        title: "제45화 스키너 — 스키너 상자와 행동 설계",
        excerpt: "1943년, 상자 안의 비둘기 세 마리가 눈앞 화면에 비친 배를 콕콕 쪼아 댔다. 한 마리는 45분 동안 만 번이 넘게 쪼았다. 그 비둘기들은 곧 폭탄 안에 들어가 배를 향해 폭탄을 몰고 갈 예정이었다. 스키너는 행동의 원리를 찾는 데서 멈추지 않고, 그 원리로 무엇인가를 만들어 보려 했다 — 아이에게 글자를 가르치는 기계, 상점처럼 토큰을 쓰는 제도, 아기를 위한 특별한 침대, 그리고 소설 속의 공동체까지. 작은 발명품들은 조용히 자리를 잡았지만, 자유와 존엄이라는 오랜 생각에 도전한 큰 그림은 거센 논란을 불러왔다. 상자 안에서 시작된 원리가 실험실을 나와 학교·병원·가정·사회로 퍼져 나간 이야기 — 그리고 그 기술은 누구를 위해, 누가 정하는가라는 무거운 물음을 남긴 사람을 좇는다.",
        card_image_url: "https://images.unsplash.com/photo-1789044069699-c29964739af9?w=400&h=530&fit=crop",
      },
    },
  },
};
